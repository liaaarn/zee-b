          ...
          <ChildCard>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  <Image
                    src="/images/fotomenu1.jpg"
                    alt="Paket Nasi Ayam Goreng"
                    fill
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="h5" gutterBottom>
                  Paket Nasi Ayam Goreng
                </Typography>
                <Typography variant="body1" sx={{ mb: 2 }}>
                  Nikmati ayam goreng khas dengan bumbu rempah spesial yang
                  meresap sempurna.
                </Typography>
        ...
        <Grid item xs={12}>
          <ChildCard>
            ...
            <Typography variant="body2">
              Paket ini terdiri dari ayam goreng, nasi, lalapan segar, sambal,
              tahu, tempe dan ikan asin. Sangat cocok untuk makan siang maupun
              malam.
            </Typography>
          </ChildCard>
        </Grid>
